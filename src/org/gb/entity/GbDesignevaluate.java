...
/**
 * GbDesignevaluate entity. @author MyEclipse Persistence Tools
 */

public class GbDesignevaluate implements java.io.Serializable {
	...
	/** default constructor */
	public GbDesignevaluate() {
	}

	/** minimal constructor */
	public GbDesignevaluate(String id) {
		this.id = id;
	}

	/** full constructor */
	public GbDesignevaluate(String id, GbBuilding gbBuilding, String nature,
